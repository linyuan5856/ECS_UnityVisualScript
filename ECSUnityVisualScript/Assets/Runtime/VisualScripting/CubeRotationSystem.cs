...
public class CubeRotationSystem : ComponentSystem
{
    ...
    {
        {
            Entities.With(Cube_Query).ForEach((Unity.Entities.Entity Cube_QueryEntity, ref Unity.Transforms.Rotation Cube_QueryRotation, ref CubeRotationComponent Cube_QueryCubeRotationComponent, ref Unity.Transforms.Translation Cube_QueryTranslation) =>
            {
                ...
                Cube_QueryTranslation.Value = new float3(0F, 0F, 0F);
            }
